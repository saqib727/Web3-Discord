...
beforeEach(async () => {
  ...
  const transction = await dapppcord.connect(deployer).createChannel('general', tokens(1))
...
describe("Dappcord", function () {
  ...
  describe("Creating Channels", function () {
    ...
    it("Returns total channe;s", async () => {
   ...
   it("Returns channel attributes",async()=>{
    ...
    const channel=await dappcord.getChanne(1);
